...
#define SPHERE_DRILL_RADIUS float(.05)
#define CONE_RADIUS float(.65)
#define CONE_LENGTH float(3.)
#define CONE_VERTICAL_OFFSET float(.625)
#define DISKS float(13.)
#define DISK_THICKNESS float(.025)
